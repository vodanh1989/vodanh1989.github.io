...
if (isset($_POST['butSaveLoai'])) {
	...
	if ($err=='')
	{
		if (!empty($_POST['id'])) {
			$oldid = $_POST['id'];
			$sql = "update link_websites set link_websites_name='".$name."',link_websites_address='".$address."',link_websites_description='".$desc."',link_websites_status='".$status."',link_websites_categoriesid='".$categories_id."', link_websites_sortorder='".$sortorder."' where link_websites_id='".$oldid."'";
		}else {
			$sql = "insert into link_websites (link_websites_name,link_websites_address,link_websites_description,link_websites_status,link_websites_dateadded,link_websites_categoriesid,link_websites_sortorder) values ('".$name."','".$address."','".$desc."','".$status."',SYSDATE(),'".$categories_id."','".$sortorder."')";
		}
